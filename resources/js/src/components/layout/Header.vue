                                ...
                                >
                                    <li>
                                        ...
                                        >
                                            ...
                                            <div
                                                class="ltr:pl-4 rtl:pr-4 truncate"
                                            >
                                                <h4 class="text-base">
                                                    {{ user.name
                                                    }}<span
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <router-link
                                ...
                                target="_blank"
                                >{{ $t("contact_us_boxed") }}</router-link
                            >
                        </li>
                        <li>
                            <router-link
                                ...
                                target="_blank"
                                >{{ $t("contact_us_cover") }}</router-link
                            >
                        </li>
                        <li>
...
const currentFlag = computed(() => {
    return `/assets/images/flags/${"VN"}.svg`;
});
